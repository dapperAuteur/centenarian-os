// lib/bvc/commodities.ts
// Better Vice Club episodes by geographic origin. Source of truth for
// the /academy/explore commodity map. 21 entries, one per episode.
// Update when a new episode is added.
