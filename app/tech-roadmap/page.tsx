...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { done: true, text: 'Threaded chat on assignment submissions (student ↔ teacher)' },
      { done: true, text: 'Course direct messages (student ↔ teacher inbox)' },
      { done: true, text: 'Teacher promo codes — apply discount codes at checkout via Stripe Coupons' },
      { done: true, text: 'Free trial periods for subscription courses' },
      { done: true, text: 'Course reviews and star ratings with trigger-based averages' },
      { done: true, text: 'Progressive metric slots per course attempt (attempt 1 = 1 metric, attempt 2 = 2, etc.)' },
      { done: true, text: 'Re-enrollment flow ("Take Again") for completed courses' },
      { done: true, text: 'AI-recommended learning paths for students (Gemini personalization)' },
      { done: true, text: 'AI path suggestions for teachers (Gemini drafts path groupings from their courses)' },
    ],
  },
  {
    id: 5,
