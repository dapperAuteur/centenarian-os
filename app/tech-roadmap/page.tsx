...
const PHASES = [
  ...
  },
  {
    ...
    items: [
      ...
      { done: true, text: 'Tutorial course series — Travel module (11 lessons, CYOA navigation)' },
      { done: true, text: 'Tutorial course series — Fuel & Nutrition module (13 lessons, CYOA navigation)' },
      { done: true, text: 'Tutorial course series — Planner module (12 lessons, CYOA navigation)' },
      ...
      { done: true, text: 'Tutorial course series — Academy student guide (9 lessons, CYOA navigation)' },
      { done: true, text: 'Tutorial course series — Teaching dashboard guide (10 lessons, CYOA navigation)' },
