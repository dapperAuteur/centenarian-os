...
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  const allowed = ['title', 'lesson_type', 'content_url', 'text_content', 'content_format', 'duration_seconds', 'order', 'is_free_preview', 'is_published', 'module_id', 'quiz_content', 'audio_chapters', 'transcript_content', 'map_content', 'documents', 'podcast_links', 'video_360_autoplay', 'video_360_poster_url'];
