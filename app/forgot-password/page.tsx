          ...
          {sent ? (
            <div className="space-y-6">
              <div className="bg-green-50 text-green-700 p-4 rounded-lg text-sm">
                We sent a password reset link to <span className="font-medium">{email}</span>. Check your inbox and click the link to set a new password.
              </div>
              <Link
                href="/login"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="reset-email" className="block text-sm font-medium mb-1 text-gray-700">
                  Email
                </label>
                <input
                  id="reset-email"
