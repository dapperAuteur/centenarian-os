...
export default function JobsListPage() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/contractor/jobs?${params}`)
      .then((r) => r.json())
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-neutral-700 bg-neutral-900 py-2 pl-9 pr-3 text-sm text-neutral-100 placeholder-neutral-500 focus:border-amber-500 focus:outline-none"
          />
        </div>
