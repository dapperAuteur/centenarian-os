          ...
          <div>
            ...
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={leanData} margin={{ top: 4, right: 8, bottom: 4, left: -10 }}>
                ...
                <Tooltip formatter={(v: number) => [`${v.toFixed(1)} lbs`, 'Lean Mass']} />
          ...
          <div>
            ...
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={fatData} margin={{ top: 4, right: 8, bottom: 4, left: -10 }}>
                ...
                <XAxis dataKey="segment" tick={{ fontSize: 11 }} />
                <YAxis tick={{ fontSize: 11 }} />
                <Tooltip formatter={(v: number) => [`${v.toFixed(1)} lbs`, 'Fat Mass']} />
                ...
                <LineChart data={chartData} margin={{ top: 4, right: 16, bottom: 4, left: -10 }}>
                  ...
                  <Tooltip
                    formatter={(v: number, name: string) =>
                      name === 'Weight' ? [`${v.toFixed(1)} lbs`, name] : [`${v.toFixed(1)}%`, name]
                    }
                  />
                  <Legend />
            ...
            <section className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
              ...
              <ResponsiveContainer width="100%" height={180}>
                <LineChart data={chartData} margin={{ top: 4, right: 16, bottom: 4, left: -10 }}>
                  ...
                  <Tooltip formatter={(v: number) => [`${v.toFixed(1)} lbs`, 'Muscle Mass']} />
            ...
            <section className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
              ...
              <ResponsiveContainer width="100%" height={160}>
                <AreaChart data={chartData} margin={{ top: 4, right: 16, bottom: 4, left: -10 }}>
                  ...
                  <XAxis dataKey="date" tick={{ fontSize: 11 }} interval="preserveStartEnd" />
                  <YAxis tick={{ fontSize: 11 }} />
                  <Tooltip formatter={(v: number) => [`${v.toFixed(0)} cm²`, 'Visceral Fat Area']} />
            ...
            <section className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
              ...
              <ResponsiveContainer width="100%" height={180}>
                <AreaChart data={chartData} margin={{ top: 4, right: 16, bottom: 4, left: -10 }}>
                  ...
                  <XAxis dataKey="date" tick={{ fontSize: 11 }} interval="preserveStartEnd" />
                  <YAxis tick={{ fontSize: 11 }} />
                  <Tooltip formatter={(v: number, name: string) => [`${v.toFixed(1)} L`, name]} />
                  <Legend />
