...
const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  workouts: {
    ...
    instructions:
      'Upload workout logs. Required: name (workout name), date. Rows with the same name + date are grouped into one workout with multiple exercises. Each row becomes one exercise.',
    columns: [
      { key: 'date', label: 'Date (YYYY-MM-DD)', required: true },
