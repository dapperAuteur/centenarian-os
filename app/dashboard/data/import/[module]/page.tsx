...
const MODULE_CONFIGS: Record<string, ModuleConfig> = {
  ...
  tasks: {
    ...
    columns: [
      ...
      { key: 'roadmap_end_date', label: 'Roadmap End (YYYY-MM-DD)' },
      { key: 'roadmap_description', label: 'Roadmap Description' },
      { key: 'goal_title', label: 'Goal Title' },
      { key: 'goal_category', label: 'Goal Category' },
      { key: 'goal_target_year', label: 'Goal Target Year' },
      { key: 'goal_description', label: 'Goal Description' },
      { key: 'milestone_title', label: 'Milestone Title' },
      { key: 'milestone_target_date', label: 'Milestone Target Date' },
      { key: 'milestone_description', label: 'Milestone Description' },
      { key: 'date', label: 'Task Date (YYYY-MM-DD)', required: true },
    ...
    previewColumns: ['milestone_title', 'date', 'activity', 'tag', 'priority'],
  },
  workouts: {
    moduleName: 'Workouts',
