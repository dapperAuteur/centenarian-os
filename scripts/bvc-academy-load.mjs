...
const EPISODES = {
  ...
  khat: {
    moduleTitle: 'Episode 20: Khat — The Afternoon Leaf',
    moduleOrder: 20,
    assignmentTitle: 'The Afternoon Leaf',
    lessons: [
  ...
  'full-spectrum': {
    moduleTitle: 'Episode 21: The Full Spectrum — Who Draws the Line?',
    moduleOrder: 21,
    assignmentTitle: 'Who Draws the Line?',
    lessons: [
