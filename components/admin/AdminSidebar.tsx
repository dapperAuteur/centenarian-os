...
import { LayoutDashboard, Users, MessageSquare, FileText, Heart, MessageCircle, GraduationCap, Radio, Activity, Building2, ScrollText, BarChart3, Link2, Sparkles, Globe, Tag, ClipboardCheck, Megaphone } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { href: '/admin/content-status', label: 'Content Status', icon: ClipboardCheck, exact: false, badgeKey: null },
];
